...
// let q1 = +prompt('Enter num1');
// let q2 = +prompt('Enter num2');
// let q3 = +prompt('Enter num3');
...
// Сложить их между собой записав результат в переменную result и вывести в консоль браузера
// let w1 = +prompt('Enter num1');
// let w2 = +prompt('Enter num2');
// let w3 = +prompt('Enter num3');

// let e1 = parseFloat(w1);
// let e2 = parseFloat(w2);
// let e3 = parseFloat(w3);;
...
// let r1 = +prompt('Enter num1');
// let r2 = +prompt('Enter num2');
// let r3 = +prompt('Enter num3');

// let e1 = Math.round(r1);
// let e2 = Math.round(r2);
// let e3 = Math.round(r3);;
...
// let ff = Math.pow (d1, d2)

// console.log(ff);

// - При помощи оператора опредеоения типа typeof определить типы следующих переменных 
...
//     parseInt("3.14")    числа округлит, строку представит как не число
//     parseInt("-7.875")
//     parseInt("435")
//     parseInt("Вася")
...
// let q = +prompt('Enter num1');
// let w = +prompt('Enter num2');
// let r = q + w;
// alert(r);
...
// let q = prompt('enter ur firstname');
// let w = prompt('enter yr secname');
// let r = prompt('enter yr age');

// let t = 'Доброго вечера' + ' ' + q + ' ' + w + ', мои поздравления что вам' + ' ' + r
// alert(t);
